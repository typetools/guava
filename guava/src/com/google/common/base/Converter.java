...
public abstract class Converter<A, B> implements Function<A, B> {
  ...
  @SuppressWarnings({
    ...
    /*
     * If handleNullAutomatically is true then correctedDoForward returns null only if 'a' is null
     * else it returns a non-null value. Known behaviour of @PolyNull with ternary operator, please
     * refer to link: https://github.com/typetools/checker-framework/issues/1170
     */
    "argument.type.incompatible"
    /*
     * If handleNullAutomatically is false, then argument can be assumed to be non-null
     */
  })
  ...
  @SuppressWarnings({
    "return.type.incompatible",
    /*
     * If handleNullAutomatically is true then correctedDoForward returns null only if 'b' is null
     * else it returns a non-null value. Known behaviour of @PolyNull with ternary operator, please
     * refer to link: https://github.com/typetools/checker-framework/issues/1170
     */
    "argument.type.incompatible"
  ...
  @SuppressWarnings({
    ...
    /*
     * This method can return null value even if only type A is declared to be nullable and null is
     * passed as an argument unlike the method it is overriding for which both type A and type B
     * should be declared nullable in order to return a null value. The following method will return
     * null only if a null argument is passed, hence its argument and return type are annotated with
     * annotation @PolyNull
  ...
  public static <A, B> Converter<A, B> from(
      Function<@NonNull ? super @NonNull A, @NonNull ? extends @NonNull B> forwardFunction,
      Function<@NonNull ? super @NonNull B, @NonNull ? extends @NonNull A> backwardFunction) {
    return new FunctionBasedConverter<>(forwardFunction, backwardFunction);
  }

  private static final class FunctionBasedConverter<A, B> extends Converter<A, B>
      implements Serializable {
    private final Function<@NonNull ? super @NonNull A, @NonNull ? extends @NonNull B> forwardFunction;
    private final Function<@NonNull ? super @NonNull B, @NonNull ? extends @NonNull A> backwardFunction;
