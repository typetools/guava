...
public final class ArrayTable<R extends @NonNull Object, C extends @NonNull Object, V>
   ...
   */
  public static <R extends @NonNull Object, C extends @NonNull Object, V> ArrayTable<R, C, V> create(
  ...
  @CanIgnoreReturnValue
  @Override
  @SuppressWarnings("nullness:unboxing.of.nullable") // checkArgument ensures rowIndex and columnIndex
  // to be non-null
   ...
   */
  @Override
  @SuppressWarnings("nullness:conditional.type.incompatible") // ImmutableMap requires both R and V
  // to be of type @NonNull
  public Map<R, V> column(C columnKey) {
    checkNotNull(columnKey);
    Integer columnIndex = columnKeyToIndex.get(columnKey);
    return (columnIndex == null) ? ImmutableMap.<R, @NonNull V>of() : new Column(columnIndex);
  }
  ...
  private class Column extends ArrayMap<R, V> {
    ...
    @Override
    @Nullable V setValue(int index, V newValue) {
   ...
   */
  @Override
  @SuppressWarnings("nullness:conditional.type.incompatible") // ImmutableMap requires both C and V
  // to be of type @NonNull
  public Map<C, V> row(R rowKey) {
    checkNotNull(rowKey);
    Integer rowIndex = rowKeyToIndex.get(rowKey);
    return (rowIndex == null) ? ImmutableMap.<C, @NonNull V>of() : new Row(rowIndex);
  }
  ...
  @Override
  @SuppressWarnings("nullness:override.return.invalid") // The getValue method may return null
  Spliterator<@Nullable V> valuesSpliterator() {
    return CollectSpliterators.indexed(size(), Spliterator.ORDERED,
        (java.util.function.IntFunction<@Nullable V>) this::getValue);
  }
