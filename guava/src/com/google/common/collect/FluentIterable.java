...
// FluentIterable is restricted to @NonNull type. Otherwise, it leaves the object in inconsistent state.
public abstract class FluentIterable<E extends @NonNull Object> implements Iterable<E> {
   ...
   */
  public static <E extends @NonNull Object> FluentIterable<E> from(final Iterable<E> iterable) {
   ...
   */
  @Beta
  public static <E extends @NonNull Object> FluentIterable<E> from(E[] elements) {
   ...
   */
  @Deprecated
  public static <E extends @NonNull Object> FluentIterable<E> from(FluentIterable<E> iterable) {
   ...
   */
  @Beta
  public static <T extends @NonNull Object> FluentIterable<T> concat(
  ...
  private static <T extends @NonNull Object> FluentIterable<T> concatNoDefensiveCopy(
   ...
   */
  @Beta
  public static <E extends @NonNull Object> FluentIterable<E> of() {
   ...
   */
  @Beta
  public static <E extends @NonNull Object> FluentIterable<E> of(E element, E... elements) {
   ...
   */
  public final <T extends @NonNull Object> FluentIterable<T> transform(
   ...
   */
  public <T extends @NonNull Object> FluentIterable<T> transformAndConcat(
   ...
   */
  @SuppressWarnings("nullness:argument.type.incompatible") // This method is expected to be called
  // only when the first element is known to be non-null
   ...
   */
  @SuppressWarnings("nullness:argument.type.incompatible") // This method is expected to be called
  // only when the last element is known to be non-null.
  ...
  private static class FromIterableFunction<E extends @NonNull Object>
