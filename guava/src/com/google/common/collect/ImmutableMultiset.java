...
public abstract class ImmutableMultiset<E extends @NonNull Object>
  ...
  @LazyInit private transient @MonotonicNonNull ImmutableList<E> asList;
  ...
  @LazyInit private transient @MonotonicNonNull ImmutableSet<Entry<E>> entrySet;
  ...
  static final class SerializedForm implements Serializable {
    ...
    SerializedForm(Multiset<@NonNull ?> multiset) {
      int distinct = multiset.entrySet().size();
      elements = new Object[distinct];
      counts = new int[distinct];
      int i = 0;
      for (Entry<@NonNull ?> entry : multiset.entrySet()) {
