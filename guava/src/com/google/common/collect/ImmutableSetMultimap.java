...
public class ImmutableSetMultimap<K extends @NonNull Object, V extends @NonNull Object>
  ...
  public static <K extends @NonNull Object, V extends @NonNull Object> ImmutableSetMultimap<K, V> of() {
  ...
  ImmutableSetMultimap<K, V> copyOf(
      Multimap<? extends K, ? extends V> multimap, @Nullable Comparator<? super V> valueComparator) {
  ...
  @Deprecated
  @Override
  public ImmutableSet<V> replaceValues(@Nullable K key, Iterable<? extends V> values) {
    throw new UnsupportedOperationException();
  }
